      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-64 border-r border-[var(--adm-border)] flex flex-col bg-[var(--adm-sidebar)] flex-shrink-0">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <Link href="/admin/histoire" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-[var(--adm-text-40)] hover:text-[var(--adm-text)] hover:bg-[var(--adm-surface)] transition-all">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
